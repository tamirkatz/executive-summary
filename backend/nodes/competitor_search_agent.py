...
class SearchQueries(BaseModel):
    """Exactly 20 search queries generated by the LLM."""

    queries: List[str] = Field(
        description="List of 20 competitor search queries", min_length=20, max_length=20
    )
...
class CompetitorSearchAgent(BaseAgent):
    ...
    async def _generate_search_queries(
        ...
        """Prompt the LLM for exactly 20 search queries."""
