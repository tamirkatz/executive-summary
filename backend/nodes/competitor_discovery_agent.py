...
class FocusedCompetitorDiscoveryAgent(BaseAgent):
    ...
    async def discover_competitors(self, company: str, description: str, industry: str, 
                                 sector: str, client_industries: List[str] = None,
                                 known_clients: List[str] = None, websocket_manager=None, 
        ...
        return {
            ...
            "detailed_analysis": [
                {
                    "name": comp,
                    "description": f"Competitor in {sector} industry",
                    "reasoning": f"Identified as {company} competitor through targeted search",
                    "confidence_score": self._calculate_confidence(comp)
                }
                for comp in validated_competitors
            ],
            "discovery_metadata": {
                "methodology": "focused_targeted_search",
...
Competitors:"""
    ...
    async def run(self, state: ResearchState) -> ResearchState:
        ...
        client_industries = company_info.get('client_industries', [])
        known_clients = company_info.get('known_clients', [])
        ...
        updated_state['competitor_discovery'] = discovery_result
