...
class MongoDBService:
    def __init__(self, uri: str):
        # Determine if we should use SSL based on the URI
        # Use SSL for MongoDB Atlas (production) but not for local development
        use_ssl = "mongodb.net" in uri or "mongodb+srv" in uri
        
        if use_ssl:
            # Use SSL for production MongoDB Atlas connections
